...
function NewsCard({ item, index }) {
  ...
  return (
    <div
      key={index}
      className="flex flex-row-reverse items-center justify-end   py-3 px-4 border-2  border-[var(--color-border)] bg-[var(--color-bg-light)] hover:bg-[var(--color-border)] rounded-[10px]"
    >
      <Image
        ...
        height={1000}
        alt="news thumbnail"
        className="min-[1024px]:w-30 min-[1024px]:h-25 w-40 h-35 max-[640px]:w-24 max-[640px]:h-20 object-contain rounded-lg"
      />
